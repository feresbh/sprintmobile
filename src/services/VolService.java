...
public class VolService {
    ...
    public ArrayList<vol> afficheVol() {
        ...
        String url = Statics.BASE_URL + "/mobile/affiche";
    ...
    public void AjouterVol(TextField idvol, TextField aerod, TextField aeroa, TextField prix, TextField placed, String image) {
        req = new ConnectionRequest();
        String url = Statics.BASE_URL + "/mobile/Vol/ajouterVol?idvol=" + idvol.getText() + "&aerod=" + aerod.getText() + "&aeroa=" + aeroa.getText().toString() + "&prix=" + prix.getText() + "&placed=" + placed.getText() + "&image=" + image;
    ...
    public void SupprimerVol(int id) {
        req = new ConnectionRequest();
        String url = Statics.BASE_URL + "/mobile/suppVol?id=" + id;
    ...
    public void UpdateVol(TextField idvol, TextField aerod, TextField aeroa, TextField prix, TextField placed, TextField image, int id) {
        req = new ConnectionRequest();
        String url = Statics.BASE_URL + "/mobile/Vol/UpdateVol?id=" + id + "&idvol=" + idvol.getText() + "&aerod=" + aerod.getText() + "&aeroa=" + aeroa.getText().toString() + "&prix=" + prix.getText() + "&placed=" + placed.getText() + "&image=" + image.getText();
