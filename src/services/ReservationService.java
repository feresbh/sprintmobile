...
public ArrayList <reservation> afficheRese (){
        ...
        String url= Statics.BASE_URL+"/mobile/afficheeR";
    ...
    public void supprimerRes(int id){
        ...
        req=new ConnectionRequest();
        String url= Statics.BASE_URL+"/mobile/suppR?id="+id;
    ...
    public void ajouterRes(TextField email,TextField cin,TextField tel){
         req=new ConnectionRequest();
        String url= Statics.BASE_URL+"/mobile/reservation/ajouterRes?email="+email.getText().toString()+"&cin="+cin.getText().toString()+"&tel="+tel.getText().toString();
        ...
        public void UpdateRes(TextField email,TextField cin,TextField tel,int id){
         req=new ConnectionRequest();
        String url= Statics.BASE_URL+"/mobile/reservation/updateRes?id="+id+"&email="+email.getText().toString()+"&cin="+cin.getText().toString()+"&tel="+tel.getText().toString();
